...
internal constructor(
    ...
    internal val isBack: Boolean = false,
) : Serializable {
    ...
    class DocumentCameraOptionsBuilder {
        ...
        fun setBack(value: Boolean): DocumentCameraOptionsBuilder {
            isBack = value
            return this
        }
        ...
        fun build(): AcuantCameraOptions {
            ...
            return AcuantCameraOptions(
                ...
                allowBox,
                autoCapture,
                bracketLengthInHorizontal,
                bracketLengthInVertical,
                defaultBracketMarginWidth,
                defaultBracketMarginHeight,
                colorHold,
                colorCapturing,
                colorBracketAlign,
                colorBracketCloser,
                colorBracketHold,
                colorBracketCapturing,
                cardRatio,
                zoomType = zoomType,
    ...
    class BarcodeCameraOptionsBuilder {
        ...
        fun build(): AcuantCameraOptions {
            @Suppress("DEPRECATION")
            return AcuantCameraOptions(
                timeInMsPerDigit = timeInMsPerDigit, digitsToShow = digitsToShow,
